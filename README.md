...
Particularly, we're using the [**Llama2-70B**]([https://replicate.com/a16z-infra/llama13b-v2-chat](https://replicate.com/replicate/llama-2-70b-chat)) model deployed by the Andreessen Horowitz (a16z) team and hosted on the [Replicate](https://replicate.com/) platform.
