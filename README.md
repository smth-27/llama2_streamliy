...
Particularly, we're using the [**Llama2-70B**](https://replicate.com/replicate/llama-2-70b-chat) model deployed by the Andreessen Horowitz (a16z) team and hosted on the [Replicate](https://replicate.com/) platform.
...
As mentioned above, this chatbot implementation uses the [**Llama2-70B**](https://replicate.com/replicate/llama-2-70b-chat) model that was trained on 7 billion parameters.

You can also try out the larger models:
- [Llama2-13B](https://replicate.com/a16z-infra/llama13b-v2-chat)
- [Llama2-7B](https://replicate.com/replicate/llama7b-v2-chat)
