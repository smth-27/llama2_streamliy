...
Particularly, we're using the [**Llama2-13B**](https://replicate.com/a16z-infra/llama70b-v2-chat) model deployed by the Andreessen Horowitz (a16z) team and hosted on the [Replicate](https://replicate.com/) platform.
